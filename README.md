...
1. **Clone the repo**:
   ...
   ```bash
   https://github.com/anisha-repository/Disease-Prediction.git
   ```
...
* **GitHub**: [github.com/anisha-repository](https://github.com/anisha-repository)
* **Email**: [anishakumari277@gmail.com](mailto:anishakumari277@gmail.com)
